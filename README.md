...
I was into tech long before pharmacy school, but it was during pharmacy training, watching patterns in dosing, workflows and inefficiencies nobody was tracking, that statistics really pulled me in. That interest peaked in 2020, watching a world lean on case counts and vaccine data to decide what happened next, and it clicked: health informatics is less about analysis and more about safeguarding the truth, keeping the right data clean and ready before anyone knows they will need it.

At some point I stopped wanting to be a pharmacist who liked data, or a data person who used to be a pharmacist. I wanted to sit at the center of both, so I started a Computer Science degree alongside the clinical training, to actually hold my own on the technical side and to stand between clinicians and engineers as someone who could translate for both, two worlds that, at least when I started, weren't really built to talk to each other.
